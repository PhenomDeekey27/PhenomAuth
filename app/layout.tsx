...
// For Material Symbols, we'll add the font via CSS in globals.css
// since Next.js font optimization doesn't support Material Symbols directly

export const metadata: Metadata = {
  title: "Cold Blue Neon - AI Backend Generator",
